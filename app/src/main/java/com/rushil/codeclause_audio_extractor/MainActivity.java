package com.rushil.codeclause_audio_extractor;
        ...
        Dexter.withActivity(this)
                ...
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionGranted(PermissionGrantedResponse response) {
                        ...
                        destDirectory = "/storage/emulated/0/Audio Extractor/";
                        fileName = "Myaudio.mp3";
                        destPath = destDirectory+fileName;

                        File mediaStorageDir = new File(Environment.getExternalStorageDirectory(), "Audio Extractor");
